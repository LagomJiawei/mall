...
import cn.net.zjw.service.sys.RoleDeptService;
...
public class RoleDeptController {
	 ...
	 * @return 角色部门关联关系信息
	 */
	@ApiOperation(notes = "通过id集合批量查询角色部门关联关系信息", value = "通过id集合批量查询角色部门关联关系信息")
	@GetMapping("/findByIds")
	public List<RoleDeptEntity> findById(List<Long> ids) {
		return roleDeptService.findByIds(ids);
	}
