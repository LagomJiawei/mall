...
import cn.net.zjw.entity.RoleMenuConditionEntity;
import cn.net.zjw.entity.RoleMenuEntity;
import cn.net.zjw.mapper.BaseMapper;
import cn.net.zjw.mapper.RoleMenuMapper;
...
public class RoleMenuService extends BaseService< RoleMenuEntity,  RoleMenuConditionEntity> {
	...
	public int deleteByIds(List<Long> ids) {
		...
		AssertUtil.notEmpty(entities, "角色菜单关联关系已被删除");
